...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = f"{com.cta.station}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        value={"station_id": station_id, "train_id": train_id, 
"direction": direction, "line": line, "train_status": train_status, 
"prev_station_id": prev_station_id, "prev_direction": prev_direction}
        )
