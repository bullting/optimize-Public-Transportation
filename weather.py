...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        #
        #
        topic_name = f"{com.cta.weather}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, month):
        ...
        data = {"value_schema": Weather.value_schema, "records": [{"value": Weather.key_schema}]}
        resp = requests.post(
        f"{REST_PROXY_URL}/topics/com.cta.weather", 
